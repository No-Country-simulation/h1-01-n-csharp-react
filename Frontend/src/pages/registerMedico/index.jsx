...
function RegisterMedico() {
    ...
    return (
        <div className={`container ${style.containerRegisterMedico}`}>
            <div className={style.containerStep}>
                <div className={style.step}>
                    ...
                    <div className={style.divStep}>
                        ...
                        <p className={style.textStep}>Ingresa tu contraseña y comfirmala</p>
                    </div>
                    <div className={style.divStep}>
                        <div className={style.stepSecuence}>
                        ...
                        <p className={style.textStep}>Ingresa tu N° de telefono</p>
                    </div>
                    <div className={style.divStep}>
                        <div className={style.stepSecuence}>
                    ...
                    <div className={style.divStep}>
                        <div className={style.stepSecuence}>
                            <div className={style.circleStep} style={getStepStyle('Paso 7')}></div>
                            <div className={style.line}></div>
                        </div>
            ...
            <div className={style.containerFormRegisterMedico}>
                <RegisterForm userType={userType} onFieldFilled={handleFieldFilled} />
            </div>
        </div>
    )
}
